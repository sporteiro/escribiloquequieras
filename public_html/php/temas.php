...
<div class="cadaPostit">
  <span class="letrasnormales">
    <a href="temas.php?escribieron=<?php echo $row_Recordlomasvisto['titulo']; ?>"><?php echo $row_Recordlomasvisto['titulo']; ?></a></span> <span class="masletras"><img src="../img/<?php echo $row_Recordlomasvisto['categoria']; ?>.png" width="25px" height="25px" alt="<?php echo $row_Recordlomasvisto['categoria']; ?>" title="Este post contiene <?php echo $row_Recordlomasvisto['categoria']; ?>"/></span>
  <br />
</div>
