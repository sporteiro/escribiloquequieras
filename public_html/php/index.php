...
<div id="laquetiene">
	<div id="logo"><a href="index.php" target="_self"><img src="../img/escribi.png" alt="escribi lo que quieras" width="250px" height="78px" class="titulares" /></a>
<!-- Busqueda-->
...
<div class="adentropostit">
	...
	<span style="float:right;"><a href="rss.php"><img src="../img/rss.png" width="20px" height="20px" alt="RSS" title="Subscribirse a lo mas visto"/></a></span>
	<hr />
	<?php do { ?>
		<div class="cadaPostit">
 			<span class="letrasnormales">   		
        		...
        		<span class="masletras"><img src="../img/<?php echo $row_Recordlomasvisto['categoria']; ?>.png" width="20px" height="20px" alt="<?php echo $row_Recordlomasvisto['categoria']; ?>" title="Este post contiene <?php echo $row_Recordlomasvisto['categoria']; ?>"/>
			</span>
			<p class="letripostit">
			<?php
...
<span class="letritas">(El titulo que va a tener tu post)</span><br />
 ...
 <span class="textfieldRequiredMsg">Todos los campos son obligatorios</span><span class="textfieldMinCharsMsg">Muy pocos caracteres</span><span class="textfieldMaxCharsMsg"> Demasiados caracteres</span></span>
	...
	<img src="../img/imagenes.png" onclick="agregarFoto()" title="Enlazar una imagen"/> <img src="../img/enlaces.png" onclick="agregarLink()" title="Agregar un enlace"/>  <img src="../img/bold.png" onclick="bold()" title="Texto en negrita"/> <img src="../img/italic.png" onclick="italic()" title="Texto en cursiva"/>
<!-- Imputs extras -->
...
<div class="adentropostit" style="width:60%; float:left;">
	...
	<span style="float:right;">	
		<a href="index.php?elegirCategoria=imagenes"><img src="../img/imagenes.png" width="25px" height="25px" alt="Imagenes" title="Ver posts que contienen imagenes"/></a>
		<a href="index.php?elegirCategoria=videos"><img src="../img/videos.png" width="25px" height="25px" alt="Videos" title="Ver posts que contienen videos"/></a>
		<a href="index.php?elegirCategoria=texto"><img src="../img/texto.png" width="25px" height="25px" alt="Texto" title="Ver posts que contienen solo texto"/></a>
	</span>
	<hr />
	<?php do { ?>
		<div class="cadaPostit">
 			<span class="letrasnormales">   		
        		...
        		<span class="masletras"><img src="../img/<?php echo $row_todo['categoria']; ?>.png" width="20px" height="20px" alt="<?php echo $row_todo['categoria']; ?>" title="Este post contiene <?php echo $row_todo['categoria']; ?>"/>
			</span>
			<p class="letripostit">
			<?php
  ...
  <br />
		...
		<?$currentPage='';?>
			<div id="flechas">
                ...
                <a href="<?php printf("%s?pageNum_todo=%d%s", $currentPage, max(0, $pageNum_todo - 1), $queryString_todo); ?>"><img src="../img/flecha.png" alt="atras" width="40" height="20" class="titulares" />
                </a>
                <a href="<?php printf("%s?pageNum_todo=%d%s", $currentPage, min($totalPages_todo, $pageNum_todo + 1), $queryString_todo); ?>">     <img src="../img/flecha2.png" alt="adelante" width="40" height="20" class="titulares" />  
                </a>
