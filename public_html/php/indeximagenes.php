    ...
    <p><span id="sprytextarea1">
      <label>CONTENIDO
		<span class="letritas">(El contenido de tu post. Podes enlazar imagenes o videos)<br /><br />
			<a href="javascript:especiales('url')"><img src="../img/imagen.gif" width="25" height="25" alt="Insertar imagen" title="Insertar imagen" />Enlazar imagenes
            </a> 
