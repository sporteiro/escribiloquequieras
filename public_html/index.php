...
$solo_categoria="";
if (isset($_GET['elegirCategoria']))	{
	$solo_categoria="WHERE categoria='".$_GET['elegirCategoria']."'";
}
...
<meta name="Description" content="Escribi lo que quieras es un sitio donde cualquier usuario es libre de publicar cualquier contenido sin registrarse." />
...
<div class="adentropostit">
	<span class="titulares">Lo mas visto ultimamente</span>
	<span style="float:right;"><a href="rss.php"><img src="rss.png" width="20px" height="20px" alt="RSS" title="Subscribirse a lo mas visto"/></a></span>
	<hr />
	<?php do { ?>
		<div class="cadaPostit">
 			<span class="letrasnormales">   		
				<a href="temas.php?escribieron=<?php echo $row_Recordlomasvisto['titulo']; ?>"><?php echo $row_Recordlomasvisto['titulo']; ?></a>
			</span>
        		<span class="masletras"><img src="<?php echo $row_Recordlomasvisto['categoria']; ?>.png" width="20px" height="20px" alt="<?php echo $row_Recordlomasvisto['categoria']; ?>" title="Este post contiene <?php echo $row_Recordlomasvisto['categoria']; ?>"/>
			</span>
			<p class="letripostit">
			<?php
			if ($row_Recordlomasvisto['categoria']=='texto')	{
				echo '<a href="temas.php?escribieron='.$row_Recordlomasvisto['titulo'].'">'.substr($row_Recordlomasvisto['asunto'],0,300).'...</a>'; 
			}
			else if ($row_Recordlomasvisto['categoria']=='imagenes')	{
				echo '<p class="minimagen">'.substr($row_Recordlomasvisto['asunto'],0,3000).'...</p>'; 
			}
			?>
			</p>
  			<br />
...
<!--
  ...
  <p class="titulares"><a href="indexvideos.php"> <img src="videos.png" width="25px" height="25px" alt="Videos" title="Ver posts que contienen videos"/>Videos</a>  <a href="indeximagenes.php"> <img src="imagen.png" width="25px" height="25px" alt="Imagenes" title="Ver posts que contienen imagenes"/> Im�genes</a> <a href="indextexto.php"> <img src="texto.png" width="25px" height="25px" alt="Texto" title="Ver posts que contienen texto"/> S�lo texto</a></p>
  </div>
-->
  </div>
...
<span class="letritas">(El titulo que va a tener tu post)</span><br />
 ...
 <span class="textfieldRequiredMsg">Todos los campos son obligatorios</span><span class="textfieldMinCharsMsg">Muy pocos caracteres</span><span class="textfieldMaxCharsMsg"> Demasiados caracteres</span></span>
    ...
    <p>
      <label>CONTENIDO</label><span class="letritas">(El contenido de tu post. Podes enlazar imagenes o videos)</span><br />
	<img src="imagenes.png" onclick="agregarFoto()" title="Enlazar una imagen"/> <img src="enlaces.png" onclick="agregarLink()" title="Agregar un enlace"/>  <img src="bold.png" onclick="bold()" title="Texto en negrita"/> <img src="italic.png" onclick="italic()" title="Texto en cursiva"/>
<!-- Imputs extras -->
		<div style="text-align:right;" id="inputsContenido">	

		</div>
<!-- FIN Imputs extras -->
	<!--
		<span class="letritas">(El contenido de tu post. Podes enlazar imagenes o videos)<br /><br />
			<a href="javascript:especiales('url')"><img src="imagen.png" width="25" height="25" alt="Insertar imagen" title="Insertar imagen" />Enlazar im�genes
		            </a> 
 			<a href="javascript:especiales('enlaces')"><img src="enlaces.png" width="25" height="25" alt="insertar enlaces" title="Insertar enlace" />Crear un enlace
		            </a>
		</span>-->
		<span id="sprytextarea1"><span class="textareaMinCharsMsg">Ten&eacute;s que escribir 100 caracteres como m&iacute;nimo</span> 
 		<textarea name="asunto" cols="45" rows="7" style="width:95%" class="imputis" id="asunto" tabindex="6" onkeydown="textCounter(this.form.asunto,this.form.remLen,2000);" onkeyup="javascript:storeCaret(this); textCounter(this.form.asunto,this.form.remLen,2000);" onchange="javascript:storeCaret(this);" onclick="javascript:storeCaret(this);"></textarea>
<br /></span>
         <span class="letritas">P&oacute;des escribir desde 100 hasta 3000 caracteres. Te quedan </span> <span id="countsprytextarea1" class="letritas">&nbsp;</span></label> </span><span class="letritas"> disponibles.</span>
      ...
      <input name="vistoid" id="vistoid" type="hidden" value="1000"/>
      <p>
      <label>
      ...
      <div class="imputis" id="recaptcha_image" style="width:300px; height:57px;"></div>
        ...
        <label>
      <input  class="imputis" tabindex="3" id="recaptcha_response_field" name="recaptcha_response_field" style="width:300px;"/></label></span>
      <? require_once('recaptchalib.php');
...
<div class="adentropostit" style="width:60%; float:left;">
	<span class="titulares">Post recientes</span> 
	<span style="float:right;">	
		<a href="index.php?elegirCategoria=imagenes"><img src="imagenes.png" width="25px" height="25px" alt="Imagenes" title="Ver posts que contienen imagenes"/></a>
		<a href="index.php?elegirCategoria=videos"><img src="videos.png" width="25px" height="25px" alt="Videos" title="Ver posts que contienen videos"/></a>
		<a href="index.php?elegirCategoria=texto"><img src="texto.png" width="25px" height="25px" alt="Texto" title="Ver posts que contienen solo texto"/></a>
	</span>
	<hr />
	<?php do { ?>
		<div class="cadaPostit">
 			<span class="letrasnormales">   		
				<a href="temas.php?escribieron=<?php echo $row_todo['titulo']; ?>"><?php echo $row_todo['titulo']; ?></a>
			</span>
        		<span class="masletras"><img src="<?php echo $row_todo['categoria']; ?>.png" width="20px" height="20px" alt="<?php echo $row_todo['categoria']; ?>" title="Este post contiene <?php echo $row_todo['categoria']; ?>"/>
			</span>
			<p class="letripostit">
			<?php
			if ($row_todo['categoria']=='texto')	{
				echo substr($row_todo['asunto'],0,300).'...'; 
			}
			else if ($row_todo['categoria']=='imagenes')	{
				echo '<p class="minimagen">'.substr($row_todo['asunto'],0,3000).'...</p>'; 
			}
			?>
			</p>
  			<br />
...
<div class="adentropostit" style="width:34%; float:right;">
	<span class="titulares">Ultimos comentarios</span> 
	<hr />
	<?php do { ?>
		<div class="cadaPostit">
			<p class="letripostit">
			<?php echo '<b>'.$row_comentarios['nombre'].' Dijo: </b><br /><a href="temas.php?escribieron='.$row_comentarios['titulo'].'#'.$row_comentarios['CodCom'].'">'.substr($row_comentarios['comentario'],0,100).'...</a><br /></p><span class="letripostit">En</span> <span class="letrasnormales"><a href="temas.php?escribieron='.$row_comentarios['titulo'].'">'.$row_comentarios['titulo'].'</a></span>';?>
			
  		<br />
		</div>
  	<?php } while ($row_comentarios = mysql_fetch_assoc($comentarios)); ?>  <br />
...
<div class="letrasnormales">
        	<a href="terminos.php">T�rminos y condiciones generales de uso</a> | <a href="http://www.escribiloquequieras.com/temas.php?escribieron=%BFque%20es%20Escribiloquequieras?">&iquest;Qu&eacute; es es escribiloquequieras? </a> | <a href="contacto.php">Contactar con el equipo de desarrollo</a>
		</div>
        <br />
...
Sitio alojado en <a href="http://www.000webhost.com/147501.html" target="_blank">000webhost</a>
 <p>
  ...
  <a href="http://www.sebastianporteiro.com" target="_blank"><img src="sebastianporteiro.gif" alt="Sebastian Porteiro" width="25px" height="25px" class="titulares" /></a></p>
<br />
</div>
<!-- FIN ULTIMO -->
...
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {counterType:"chars_remaining", counterId:"countsprytextarea1", minChars:100, maxChars:3000});
//-->
</script>
